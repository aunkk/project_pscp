...
bang_name = pygame.image.load("project_game/city_choosing/Bangkok_sign.png")
...
italy_name = pygame.image.load("project_game/city_choosing/rome_sign.png")
...
tokyo_name = pygame.image.load("project_game/city_choosing/tokyo_sign.png")
